...
export async function PUT(
  ...
  if (typeof body.deployment_mode === 'string' && ['widget_only', 'page_only', 'widget_and_page', 'widget_handoff_to_page'].includes(body.deployment_mode)) updates.deployment_mode = body.deployment_mode;
