...
export const DEFAULT_SEO = {
  ...
  description:
    'AI website assistant that learns from your site, answers customer questions, captures and qualifies leads with AI, collects quote requests with configurable forms and estimates, and automates follow-up. Add one script for a chat widget or full-page assistant.',
  keywords: [
