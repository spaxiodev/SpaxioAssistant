(function() {
  ...
  function mount(initialConfig) {
    ...
    '.spaxio-close{position:absolute;right:12px;top:12px;width:40px;height:40px;border:none;border-radius:9999px;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.7);color:#fff;cursor:pointer;box-shadow:0 2px 12px rgba(0,0,0,0.4);opacity:0;pointer-events:none;visibility:hidden;transform:scale(0.92);transition:opacity 0.2s ease,visibility 0s linear 0.2s,transform 0.2s ease,background 0.2s ease;z-index:2147483647}',
    ...
    '.spaxio-close:hover{background:rgba(15,23,42,0.88)}',
    '.spaxio-close:focus{outline:2px solid #fff;outline-offset:2px}',
    '.spaxio-close svg{width:18px;height:18px;stroke:currentColor}',
