...
- Spaxio Assistant is an AI website assistant for businesses. Core functions: learns your business from website URL or files (Website Info / Business Info); answers visitor questions 24/7; captures leads with AI qualification (score, priority, summary); collects quote requests with configurable form and pricing rules for estimates; deploys as chat widget and/or full-page link; optionally voice conversations (plan-gated); Auto Follow-up (notify on lead, webhook triggers); AI follow-up suggestions; team, billing, settings.
...
- This AI Setup Assistant can help configure: assistant behavior (tone, greeting, what to capture), lead capture and quote request forms, notification emails, and simple Auto Follow-up (for example: "notify me when a lead comes in").
