...
- Spaxio Assistant is an AI website assistant for businesses. Core functions: learns your business from website URL or files (Knowledge); answers visitor questions 24/7; captures leads with AI qualification (score, priority, summary); collects quote requests with configurable form and pricing rules for estimates; deploys as chat widget and/or full-page link; optionally voice conversations (plan-gated); automations (notify on lead, webhook triggers); AI follow-up suggestions; team, billing, settings.
