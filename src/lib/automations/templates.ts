...
export const AUTOMATION_TEMPLATES: AutomationTemplate[] = [
  ...
  {
    key: 'lead_auto_reply_template',
    title: 'Lead auto-reply email',
    description: 'Automatically send a professional confirmation email after a lead form submission.',
    icon: Bell,
  ...
  {
    key: 'quote_ai_draft_followup',
    title: 'Quote request AI draft',
    description: 'Generate an AI follow-up draft for review when a quote request is submitted.',
    icon: FileText,
    trigger_type: 'quote_request_submitted',
    default_trigger_config: {},
    action_type: 'generate_followup_draft',
    default_action_config: {
      mode: 'ai_draft_for_approval',
