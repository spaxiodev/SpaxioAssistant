...
/** Optional stats to show in the footer instead of nodes/connections (e.g. dashboard website stats). */
...
const colorClasses: Record<string, string> = {
  emerald: "border-zinc-400/40 bg-zinc-400/10 text-zinc-700 dark:text-zinc-300",
  blue: "border-zinc-500/40 bg-zinc-500/10 text-zinc-700 dark:text-zinc-300",
  amber: "border-zinc-600/40 bg-zinc-600/10 text-zinc-800 dark:text-zinc-200",
  purple: "border-zinc-500/40 bg-zinc-500/10 text-zinc-700 dark:text-zinc-300",
  indigo: "border-zinc-600/40 bg-zinc-600/10 text-zinc-800 dark:text-zinc-200",
};
...
export function N8nWorkflowBlock({
  ...
  const showWebsiteStats = websiteStats != null;
    ...
    <div className="relative w-full overflow-hidden rounded-2xl border border-border/40 bg-background/60 backdrop-blur p-4 sm:p-6">
      ...
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <Badge
            variant="outline"
            className="rounded-full border-zinc-400/40 bg-zinc-400/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.25em] text-zinc-700 dark:text-zinc-300"
          >
            Active
          </Badge>
      ...
      {/* Footer Stats: website stats or nodes/connections */}
      <div
      ...
      >
            ...
            <>
              <div className="flex items-center gap-2">
                ...
                <span className="uppercase tracking-[0.15em]">
                  {websiteStats.leads} {labels.leads ?? "Leads"}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <div
                ...
                />
                <span className="uppercase tracking-[0.15em]">
                  {websiteStats.conversations} {labels.conversations ?? "Conversations"}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <div
                ...
                />
                <span className="uppercase tracking-[0.15em]">
                  {websiteStats.quoteRequests} {labels.quoteRequests ?? "Quote requests"}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <div
                ...
                />
                <span className="uppercase tracking-[0.15em]">
                  {websiteStats.widgets} {labels.widgets ?? "Widgets"}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <div
                ...
                />
                <span className="uppercase tracking-[0.15em]">
                  {websiteStats.agents} {labels.agents ?? "Agents"}
                </span>
              </div>
            </>
          ) : (
        ...
        <p className="text-[10px] uppercase tracking-[0.2em] text-foreground/40">
          {showWebsiteStats ? (labels.dragHint ?? "Your website at a glance") : "Drag nodes to reposition"}
        </p>
      </div>
    </div>
  );
